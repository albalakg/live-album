            ...
            <tr>
                <td align="center">
                    <div class="content">
                        <div>
                            <h1>
                                היי {{ $data['first_name'] }}, <span class="blue--text">האירוע {{ $data['event_name']}} נסגר</span>
                            </h1>
                            <p>
                                מצטערים אך לא ניתן לגשת לאירוע שוב.
                                <br>
                                מקווים שנהנתם מהאירוע
                                <br>
                                ונשמח להיות כאן בשבילכם גם באירועים הבאים.
                                <br>
                                <br>
                                בברכה,
                                <br>
