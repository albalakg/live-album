                ...
                <td align="center">
                    <div class="content">
                        <div>
                            ...
                            <p>
                                תודה רבה שבחרתם בנו ומקווים מאוד שתהנו מהמוצר
                                <br>
                                עלות ההזמנה הינה {{ $data ['price'] }} ש"ח.
                                <br>
                                הקבצים של האירוע יהיו זמינים עד 30 ימים לאחר האירוע.
                                <br>
                                לאחר מכן יימחקו ולא יהיה ניתן לשחזור.
                                <br>
                                <br>
                                בברכה,
                                <br>
                        ...
                        <br>
                        <a href="{{ config('app.client_url') }}/events/{{ $data['event_id'] }}">
                            <button>
                                היכנס לעמוד האירוע
                            </button>
                        </a>
